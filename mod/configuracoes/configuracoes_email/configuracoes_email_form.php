...
$aplicacao_descricao = "Insere e edita configuracoes de e-mail.";

require_once __DIR__ . '/../../../includes/layout.php';
require_login();
render_header('Configuracao de E-mail', [
...
<form id="configuracoes-email-form" class="card card-slim form-section" data-id="<?= $id ?>">
    <div class="card-body row g-3">
        ...
        <div class="col-12 col-md-3"><label class="form-label">Habilitado</label><select class="form-select" name="Habilitado"><option value="1">Sim</option><option value="0">Nao</option></select></div>
        <div class="col-12 col-md-3"><label class="form-label">Autenticado</label><select class="form-select" name="ModoAutenticado"><option value="S">Sim</option><option value="N">Nao</option></select></div>
        <div class="col-12 col-md-3"><label class="form-label">SSL</label><select class="form-select" name="ModoSSL"><option value="S">Sim</option><option value="N">Nao</option></select></div>
