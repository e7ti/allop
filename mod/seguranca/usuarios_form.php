...
$aplicacao_descricao = "Insere e edita usuarios do sistema.";
...
<form id="entity-form" class="card card-slim form-section" data-entity="usuarios" data-id="<?= $id ?>">
    <div class="card-body row g-3">
        ...
        <div class="col-12 col-md-6"><label class="form-label">Ativo</label><select class="form-select" name="ativo"><option value="1">Sim</option><option value="0">Nao</option></select></div>
    </div>
