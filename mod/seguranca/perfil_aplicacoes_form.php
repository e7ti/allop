...
$aplicacao_descricao = "Formulário de permissões de aplicações por perfil.";
...
<section class="card card-slim grid-shell permission-manager">
    ...
    <div class="card-body">
        <div id="perfil-apps-empty" class="permission-empty">
            Informe o perfil para carregar as aplicações.
        </div>
        <div id="perfil-apps-accordion" class="accordion permission-accordion d-none"></div>
    </div>
    <div class="card-footer bg-white d-flex justify-content-end">
        <button class="btn btn-orange btn-save" id="btn-salvar-perfil-apps" type="button" disabled>Salvar permissões</button>
    </div>
</section>
<script>
